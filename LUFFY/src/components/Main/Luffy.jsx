...
/**
 * Luffy 컴포넌트는 사용자의 경험치 레벨에 따라 러피의 상태를 표시합니다.
 * 
 * @component
 * @param {object} props - 컴포넌트에 전달되는 props
 * @param {number} props.dday - 상담 시작 후 경과한 일 수
 */
  ...
  <div id="LuffyCounselName" className="flex flex-row items-center">
    ...
    <p className="text-[1.2vw] text-text-black">
      <span style={{ fontWeight: 'bold' }}> 
        {nickname === userInfos[0].nickname ? userInfos[1].nickname : userInfos[0].nickname}
      </span> 상담사
    </p>
  </div>
